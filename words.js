...
const DAILY_WORDS = [
    ...
    'DOCKER', 'DOCTOR', 'DOMAIN', 'DONATE', 'DOUBLE', 'DRAWER', 'DRIVEN', 'DRIVER',
    ...
    'ENTITY', 'EQUITY', 'ESCAPE', 'ESTATE', 'ETHNIC', 'EUROPE', 'EVOLVE', 'EXCEED',
    ...
    'FORMAL', 'FORMAT', 'FORMER', 'FOSTER', 'FOUGHT', 'FOURTH', 'FRANCE', 'FREEZE',
    'FRENCH', 'FRIEND', 'FROZEN', 'FUSION', 'FUTURE', 'GALAXY', 'GARAGE', 'GARDEN',
    'GATHER', 'GENDER', 'GENIUS', 'GENTLE', 'GLOBAL', 'GOLDEN', 'GOVERN', 'GRAVEL',
    'GREECE', 'GROUND', 'GROWTH', 'GUILTY', 'GUITAR', 'HAPPEN', 'HARDLY', 'HATRED',
    ...
    'LITTLE', 'LIVING', 'LOCATE', 'LOCKED', 'LONDON', 'LONELY', 'LONGER', 'LOSING',
    ...
    'PURSUE', 'PUZZLE', 'PYTHON', 'RABBIT', 'RACIAL', 'RADIUS', 'RAISED', 'RANDOM',
    ...
    'SOCIAL', 'SOCKET', 'SOLELY', 'SOLEMN', 'SOLVED', 'SOURCE', 'SOVIET', 'SPEECH',
    ...
    'VERBAL', 'VERIFY', 'VESSEL', 'VICTIM', 'VIENNA', 'VIEWER', 'VIKING', 'VIOLIN',
